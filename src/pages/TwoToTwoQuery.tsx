...
export default function TwoToTwoQuery() {
  ...
  const twoTwoBaseListHeight = useMemo(() => {
    ...
    if (results.length <= SMALL_RESULT_THRESHOLD) {
      return results.length * twoTwoCompactRowHeight + 16
    }
  ...
  }, [twoTwoBaseListHeight, twoTwoViewportHeight])
              ...
              <div className="min-w-full" style={{ minWidth: twoTwoMinWidth }}>
                ...
                >
                  ...
                  >
                    ...
                    <div className="px-3 py-2 text-center bg-green-50 dark:bg-green-900/30 col-span-2" role="columnheader">
                      Outputs
                    </div>
